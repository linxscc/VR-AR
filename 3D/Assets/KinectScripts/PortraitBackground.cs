...
/// <summary>
/// [T:以纵向模式设置彩色背景图像。 Kinect v2的游戏视图的长宽比应设为9:16，Kinect v1的3：4。] Sets the color background image in portrait mode. The aspect ratio of the game view should be set to 9:16 for Kinect v2 or 3:4 for Kinect v1.
/// </summary>
