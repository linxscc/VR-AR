...
/// <summary>
/// [T:头像控制器是将捕获的用户动作传输到人形生物模型（化身）的组件。 头像控制器经典可以将模型的绑定骨骼手动分配给Kinect的跟踪关节。]Avatar controller is the component that transfers the captured user motion to a humanoid model (avatar). Avatar controller classic allows manual assignment of model's rigged bones to the Kinect's tracked joints.
/// </summary>
