...
public class MouseControl
{
    ...
    // [T:公共功能将鼠标光标移动到指定位置] Public function to move the mouse cursor to the specified position
    ...
    /// <summary>
    ///  [T:找到与屏幕尺寸最接近的匹配子窗口] find the closest matching child window to the screen size
    /// </summary>
    ...
    /// <summary>
    /// [T:模拟鼠标 左键点击] Public function to emulate a mouse button click (left button)
    /// </summary>
    ...
    /// <summary>
    /// [T:公共功能来模拟鼠标拖动事件（左键）]Public function to emulate a mouse drag event (left button)
    /// </summary>
    ...
    /// <summary>
    ///  [T:公共功能来模拟鼠标释放事件（左键）] Public function to emulate a mouse release event (left button)
    /// </summary>
