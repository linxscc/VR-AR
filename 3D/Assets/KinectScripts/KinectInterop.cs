...
/// <summary>
/// [T:KinectInterop是一个包含实用程序和互操作功能并处理不同种类的传感器接口的类。] KinectInterop is a class that contains utility and interop functions and deals with different kinds of sensor interfaces.
/// </summary>
public class KinectInterop
{
    ...
    // [T:深度传感器平台[SDK]的类型]Types of depth sensor platforms
    ...
    // [T:将C＃与本机包装器进行连接的数据结构] Data structures for interfacing C# with the native wrappers
    ...
    {
        // [T:参数由传感器接口填充]parameters filled in by the sensor interface
    ...
    // [T:初始化可用的传感器接口] initializes the available sensor interfaces
    ...
    // [T:开启默认的传感器] opens the default sensor and needed readers
    ...
    // [T:返回给定关节的镜面关节] returns the mirror joint of the given joint
