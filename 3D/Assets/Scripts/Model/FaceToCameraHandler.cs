...
namespace ModelViewerProject.Model
{
    ...
    public class FaceToCameraHandler : MonoBehaviour
    {
        ...
        private void HandleOnRotate(Label3DHandler rawLocalPosition, TweenCallback OnComplete)
        {
            ...
            Tweener t = transform.DOLocalMove(-new Vector3(rawLocalPosition.transform.localPosition.x * transform.localScale.x* rawLocalPosition.transform.parent.localScale.x,
                rawLocalPosition.transform.localPosition.y * transform.localScale.x * rawLocalPosition.transform.parent.localScale.y, rawLocalPosition.transform.localPosition.z * transform.localScale.x * rawLocalPosition.transform.parent.localScale.z + 2.9f), 0.5f);
