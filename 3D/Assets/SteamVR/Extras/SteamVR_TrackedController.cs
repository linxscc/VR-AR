...
//委托,点击事件句柄
public delegate void ClickedEventHandler(GameObject sender, ClickedEventArgs e);
   ...
   // [HideInInspector]
    ...
    public virtual void OnMenuClicked(ClickedEventArgs e)
    {
        if (MenuButtonClicked != null)
            MenuButtonClicked(gameObject, e);
    }
    ...
    public virtual void OnMenuUnclicked(ClickedEventArgs e)
    {
        if (MenuButtonUnclicked != null)
            MenuButtonUnclicked(gameObject, e);
    }
