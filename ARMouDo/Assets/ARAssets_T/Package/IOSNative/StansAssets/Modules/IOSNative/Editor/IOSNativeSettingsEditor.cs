    ...
    public Texture[] ToolbarImages
    {
        get
        {
            if (_ToolbarImages == null)
            {
                ...
                Texture2D appstore = SA.Common.Editor.Tools.GetEditorTexture("ARAssets_T/Package/IOSNative/StansAssets/Modules/IOSNative/Editor/Icons/appstore.png");
                Texture2D gamecenter = SA.Common.Editor.Tools.GetEditorTexture("ARAssets_T/Package/IOSNative/StansAssets/Modules/IOSNative/Editor/Icons/gamecenter.png");
                Texture2D media = SA.Common.Editor.Tools.GetEditorTexture("ARAssets_T/Package/IOSNative/StansAssets/Modules/IOSNative/Editor/Icons/media.png");
                Texture2D settings = SA.Common.Editor.Tools.GetEditorTexture("ARAssets_T/Package/IOSNative/StansAssets/Modules/IOSNative/Editor/Icons/settings.png");
                Texture2D ios = SA.Common.Editor.Tools.GetEditorTexture("ARAssets_T/Package/IOSNative/StansAssets/Modules/IOSNative/Editor/Icons/ios.png");
                Texture2D camera = SA.Common.Editor.Tools.GetEditorTexture("ARAssets_T/Package/IOSNative/StansAssets/Modules/IOSNative/Editor/Icons/camera.png");
                Texture2D editorTesting = SA.Common.Editor.Tools.GetEditorTexture("ARAssets_T/Package/IOSNative/StansAssets/Modules/IOSNative/Editor/Icons/editorTesting.png");
                Texture2D xcode = SA.Common.Editor.Tools.GetEditorTexture("ARAssets_T/Package/IOSNative/StansAssets/Modules/IOSNative/Editor/Icons/xcode.png");
