        ...
        public Texture[] ToolbarImages
        {
            get
            {
                if (_ToolbarImages == null)
                {
                    ...
                    Texture2D buildSettings = SA.Common.Editor.Tools.GetEditorTexture("ARAssets_T/Package/IOSNative/StansAssets/Modules/IOSDeploy/Scripts/Editor/Icons/BuildSettings.png");
                    Texture2D framework = SA.Common.Editor.Tools.GetEditorTexture("ARAssets_T/Package/IOSNative/StansAssets/Modules/IOSDeploy/Scripts/Editor/Icons/frameworks.png");
                    Texture2D languages = SA.Common.Editor.Tools.GetEditorTexture("ARAssets_T/Package/IOSNative/StansAssets/Modules/IOSDeploy/Scripts/Editor/Icons/languages.png");
                    Texture2D libraries = SA.Common.Editor.Tools.GetEditorTexture("ARAssets_T/Package/IOSNative/StansAssets/Modules/IOSDeploy/Scripts/Editor/Icons/Libraries.png");
                    Texture2D linkerFlags = SA.Common.Editor.Tools.GetEditorTexture("ARAssets_T/Package/IOSNative/StansAssets/Modules/IOSDeploy/Scripts/Editor/Icons/linkerFlags.png");
                    Texture2D plistVariables = SA.Common.Editor.Tools.GetEditorTexture("ARAssets_T/Package/IOSNative/StansAssets/Modules/IOSDeploy/Scripts/Editor/Icons/plistVariables.png");
