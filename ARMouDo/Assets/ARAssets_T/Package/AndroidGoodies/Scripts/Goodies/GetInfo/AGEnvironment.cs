...
namespace DeadMosquito.AndroidGoodies
{
    ...
    public static class AGEnvironment
    {
        ...
        /// <summary>
        /// Standard directory in which to place pictures that are available to the user.用于放置用户可用的图片的标准目录。
        /// </summary>
        ...
        public static string DataDirectoryPath
        {
            get
            {
                return GetFileDirectory("getDataDirectory");
            }
        }
        ...
        public static string DownloadCacheDirectoryPath
        {
            get
            {
                return GetFileDirectory("getDownloadCacheDirectory");
            }
        }
        ...
        public static string ExternalStorageDirectoryPath
        {
            get
            {
                return GetFileDirectory("getExternalStorageDirectory");
            }
        }
        ...
        public static string RootDirectoryPath
        {
            get
            {
                return GetFileDirectory("getRootDirectory");
            }
        }
        ...
        private static string GetFileDirectory(string methodName, params object[] args)
        {
            ...
            try
            {
                ...
                {
                    return env.CallStaticAJO(methodName, args).CallStr("getAbsolutePath");
                }
            }
            catch (Exception e)
            {
