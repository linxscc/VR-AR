...
namespace MoDouAR
{
    ...
    public class SystemDefineTag 
    {
        ...
        /// 3DuiCanvas
        /// </summary>
        public static string canvas3D = "UI/Canvas3D";
        /// <summary>
        /// 3d ui按钮
        /// </summary>
        public const string childItem3D = "UI/ChildItem3D";
        /// <summary>
        /// 模型库类型按钮预制物位置
        /// </summary>
        public const string typeButtonURL = "UI/TypeButton";
        /// <summary>
        /// 模型库模型按钮预制物位置
        /// </summary>
        public const string modelButtonURL = "UI/ModelButton";
        public const string arKitControlURL = "ARkitControl";
        /// <summary>
        /// 标签常量
        /// </summary>
