...
using UnityEngine;
    ...
    public class ResourcesLod_T
    {
        ...
        /// <param name="YZJname">资源名</param>
        /// <returns></returns>
        static public GameObject ResourcesLodObj(string path, string YZJname)
        {
            UnityEngine.Object obj_ = Resources.Load(path + "/" + YZJname, typeof(GameObject));
        ...
        /// <returns></returns>
        static public GameObject ResourcesLodObj(string path, string YZJname, Transform parent)
        {
            UnityEngine.Object obj_ = Resources.Load(path + "/" + YZJname, typeof(GameObject));
        ...
        /// 加载GameObject 
        /// </summary>
        /// <param name="YZJname">路径+资源名</param>
        /// <returns></returns>
        ...
        /// <param name="YZJname">路径+资源名</param>
        /// <returns></returns>
        static public ParticleSystem ResourcesLodPar(string path, string YZJname)
        {
            UnityEngine.Object obj_ = Resources.Load(path + "/" + YZJname, typeof(ParticleSystem));
