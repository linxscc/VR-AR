...
public class Test : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        //下载模型
        StartCoroutine(loadasset("ftp://192.168.0.110/Bu1+WaspHub001.assetbundle"));
        //得到文本中每一行的内容
    ...
    IEnumerator loadasset(string url)
    {
        ...
        if (w.isDone)
        {
            ...
            //写入模型到本地
            CreateModelFile(Application.persistentDataPath, "Bu1+WaspHub001.assetbundle", model, length);
        }
    }
    ...
    */
    ...
    void OnGUI()
    {
        ...
        {
            StartCoroutine(LoadModelFromLocal(Application.persistentDataPath, "Bu1+WaspHub001.assetbundle"));
        }
    }
    private void Update()
    {
