...
public class Global
{
    ...
    /// 发送短信 API
    /// </summary>
    public static string SendmessageAPI = "http://ar.vplace.com.cn/api/sendCode?mobile=";
    /// <summary>
    /// 登录API
    /// </summary>
    public static string LogonAppAPI = "http://ar.vplace.com.cn/api/login?mobile=";
    /// <summary>
    /// 发送Token信息 API
    /// </summary>
    public static string SendTokenAPI = "http://ar.vplace.com.cn/api/userInfo?";
    #endregion //用户登录相关信息...
   ...
   // public static GameObject aRKit_PlaneAnchor;
    ...
    /// ARKit 点云 预制 名字
    /// </summary>
    public static readonly string pointCloudParticlePrefabYZJPath = "ARPrefbas/ARKit";
    /// <summary>
    /// ARKit识别平面显示框 预制名字
    /// </summary>
    ...
    /// 开始场景
    /// </summary>
    public static string modouAR = "MoDouAR";
    /// <summary>
    /// 模型浏览界面
    /// </summary>
    ...
    /// 模型的操作模式
    /// </summary>
    private static OperatorMode operatorModel = OperatorMode.BrowserMode;
            ...
            switch (operatorModel)
            {
               // case OperatorMode.SelectMode:
                ...
                case OperatorMode.BrowserMode:
                    ...
                    ARKitControl.Instance.IntoOther();
                    TitleMenu.Instance.SetBackGround("Browse");
                    BottomMenu.Instance.takePhoto.gameObject.SetActive(false);
                    TakePhoto.Instance.Close();
                    MrControl.Instance.Close();
                    break;
                case OperatorMode.ARMode:
                    ARKitControl.Instance.IntoAR();
                    TitleMenu.Instance.SetBackGround("AR");
                    BottomMenu.Instance.takePhoto.gameObject.SetActive(true);
                    MrControl.Instance.Close();
                    break;
                case OperatorMode.MRModel:
                    ARKitControl.Instance.IntoMR();
                    TitleMenu.Instance.SetBackGround("MrGlasses");
                    BottomMenu.Instance.takePhoto.gameObject.SetActive(false);
                    TakePhoto.Instance.Close();
                    MrControl.Instance.Close();
                    break;
