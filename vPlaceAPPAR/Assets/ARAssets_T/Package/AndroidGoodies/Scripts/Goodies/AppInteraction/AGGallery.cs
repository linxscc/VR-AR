...
namespace DeadMosquito.AndroidGoodies
{
    ...
    public static class AGGallery
    {
        ...
        /// <summary>
        /// Picks the image from gallery.从 先相册挑选图片
        /// </summary>
        /// <param name="onSuccess">On success callback. Image is received as callback parameter  成功回调</param>
        /// <param name="onError">On error callback. 错误回调</param>
