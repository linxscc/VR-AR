...
namespace SA.Common {
  ...
  //      public const string MODULS_PATH 	 			 = "Plugins/StansAssets/Modules/";
        ...
        public const string BUNDLES_PATH = "ARAssets_T/Package/IOSNative/StansAssets/Bundles/";
        public const string MODULS_PATH = "ARAssets_T/Package/IOSNative/StansAssets/Modules/";
        public const string SUPPORT_MODULS_PATH = "ARAssets_T/Package/IOSNative/StansAssets/Support/";
